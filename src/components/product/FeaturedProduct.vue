  ...
  <section class="featured-products py-5">
    <div class="container">
      ...
      <div class="text-center mb-5">
        ...
        <p class="section-subtitle text-muted">Get The Best Deals Now</p>
      </div>
      ...
      <div class="carousel-container position-relative">
        ...
        >
          ...
          >
            <ProductCard 
              :product="product"
              :badge="{ text: 'FEATURED', type: 'primary' }"
...
const totalDots = computed(() => {
  return Math.ceil(featuredProducts.value.length / 4);
});
...
const scrollCarousel = (direction: 'prev' | 'next') => {
  ...
  const scrollAmount = (slideWidth + gap) * 4; // Scroll 4 items at a time
