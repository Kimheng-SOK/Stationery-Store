<template>
  <div class="privacy-page">
    ...
    <p>
      ...
      Thank you for choosing to be part of our community at __________ (“Company“, “we“, “us“,
      ...
      your personal information, please contact us at __________.<br /><br />
      When you and more generally, use any of our services (the “Services“, which include the ), we
      ...
      this privacy notice that you do not agree with, please discontinue use of our Services
      immediately.<br /><br />
      This privacy notice applies to all information collected through our Services (which, as
      described above, includes our ), as well as, any related services, sales, marketing or events.
    </p>
    <br />
    <p class="text">
    ...
    <!-- Collapsible Answers -->
    <div v-if="selected !== null" class="answer mt-4" v-html="answers[selected]"></div>
  </div>
</template>
  ...
  setup() {
    ...
    const answers = [
      ...
      <p>Personal information you disclose to us <br />
        ...
        information that you voluntarily provide to us when you register on the express an interest in
        obtaining information about us or our products and Services, when you participate in
        activities on the (such as by posting messages in our online forums or entering competitions,
        contests or giveaways) or otherwise when you contact us.<br />
        The personal information that we collect depends on the context of your interactions with us
        and the , the choices you make and the products and features you use. The personal information
        ...
        account. If you choose to register in this way, we will collect the information described in
        the section called “HOW DO WE HANDLE YOUR SOCIAL LOGINS?” below. All personal information that
        you provide to us must be true, complete and accurate, and you must notify us of any changes
        ...
        device characteristics — is collected automatically when you visit our .<br />
        ...
        location, information about how and when you use our and other technical information. This
        information is primarily needed to maintain the security and operation of our , and for our
        internal analytics and reporting purposes. Like many businesses, we also collect information
        through cookies and similar technologies.
      </p>`,
      `<nav class='Point'>2. WHAT ARE YOUR PRIVACY RIGHTS?</nav>
      <p>In Short: You may review, change, or terminate your account at any time. <br /><br />
        ...
        http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm. <br />
        If you are a resident in Switzerland, the contact details for the data protection authorities
        are available here: https://www.edoeb.admin.ch/edoeb/en/home.html.<br /><br />
      ...
      `<nav class='Point'>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</nav>
      <p>
        In Short: We only share information with your consent, to comply with laws, to provide you
        with services, to protect your rights, or to fulfill business obligations. <br />
        ...
        certain products, services or promotions. <br />
        Other Users. When you share personal information or otherwise interact with public areas of
        the , such personal information may be viewed by all users and may be publicly made available
        outside the in perpetuity. If you interact with other users of our and register for our
        ...
        view descriptions of your activity, communicate with you within our , and view your profile.
      </p>`,
      `<nav class='Point'>4. CONTROLS FOR DO-NOT-TRACK FEATURES</nav>
      <p>
      ...
      `<nav class='Point'>5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</nav>
      <p>
      ...
      `<nav class='Point'>6. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</nav>
      <p>
      ...
      `<nav class='Point'>7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</nav>
      <p>
        In Short: If you choose to register or log in to our services using a social media account, we
        may have access to certain information about you. <br />
        ...
        your name, email address, friends list, profile picture as well as other information you
        choose to make public on such social media platform.<br />
      ...
      `<nav class='Point'>8. DO WE MAKE UPDATES TO THIS NOTICE?</nav>
      <p>
      ...
      `<nav class='Point'>9. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</nav>
      <p>
        ...
        SHARED WITH ANYONE?” above), in and other countries. <br />
        ...
        as those in your country. We will however take all necessary measures to protect your personal
        information in accordance with this privacy notice and applicable law.
      </p>`,
      `<nav class='Point'>10. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</nav>
      <p>
      ...
      `<nav class='Point'>11. HOW LONG DO WE KEEP YOUR INFORMATION?</nav>
      <p>
        In Short: We keep your information for as long as necessary to fulfill the purposes outlined
        in this privacy notice unless otherwise required by law.<br />
        ...
        require us keeping your personal information for longer than __________.<br />
      ...
      `<nav class='Point'>12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</nav>
      <p>
      ...
      `<nav class='Point'>13. DO WE COLLECT INFORMATION FROM MINORS?</nav>
      <p>
        ...
        the , you represent that you are at least 18 or that you are the parent or guardian of such a
        minor and consent to such minor dependent’s use of the . If we learn that personal information
        ...
        any data we may have collected from children under age 18, please contact us at __________.
      </p>`,
    ]
    const selected = ref<null | number>(null)
    return { items, answers, selected }
  },
})
</script>
