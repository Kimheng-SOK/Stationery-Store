<template>
  <div class="privacy-page">
    ...
    <p>Last updated __________<br>
      Thank you for choosing to be part of our community at __________ (“Company“, “we“, “us“, “our“). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at __________.<br><br>

      When you and more generally, use any of our services (the “Services“, which include the ), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.<br><br>
    ...
    <p class="text">Please read this privacy notice carefully as it will help you understand what we do with the information that we collect.</p><br>
    ...
    <br>
    <!-- 1. -->
    <p class="Point">1. WHAT INFORMATION DO WE COLLECT?</p>
    ...
    The personal information that we collect depends on the context of your interactions with us and the , the choices you make and the products and features you use. The personal information we collect may include the following:<br>
    ...
    In Short:  Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our .<br>
    ...
    Like many businesses, we also collect information through cookies and similar technologies.</p><br>

    <!-- 2. -->
    <br>
    <p class="Point">2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</p>

    <p> In Short:  We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations. <br>
    ...
    <!-- 3. -->
    <br>
    <p class="Point">3. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</p>

    <p>In Short:  We may use cookies and other tracking technologies to collect and store your information.
    We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice.</p><br>

    <!-- 4. -->
    <br>
    <p class="Point">4. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</p>
    ...
    <!-- 5. -->
    <br>
    <p class="Point">5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</p>
    ...
    <!-- 6. -->
    <br>
    <p class="Point">6. HOW LONG DO WE KEEP YOUR INFORMATION?</p>
    ...
    Opting out of email marketing: You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list — however, we may still communicate with you, for example to send you service-related emails that are necessary for the administration and use of your account, to respond to service requests, or for other non-marketing purposes. To otherwise opt-out, you may: </p><br>

    <!-- 9. -->
    <br>
    <p class="Point">9. CONTROLS FOR DO-NOT-TRACK FEATURES </p>
    ...
    <!-- 10. -->
    <br>
    <p class="Point">10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</p>

    <p>In Short:  Yes, if you are a resident of California, you are granted specific rights regarding access to your personal information.<br>
    ...
    <!-- 12. -->
    <br>
    <p class="Point">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</p>

    <p>If you have questions or comments about this notice, you may email us at __________ or by post to: <br>
    __________ <br>
    __________ <br>
    __________ <br>
    </p><br>
    ...
    <!-- 13. -->
    <br>
    <p class="Point">13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</p>
